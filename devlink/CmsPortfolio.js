...
export function CmsPortfolio({ as: _Component = _Builtin.Block }) {
	return (
		<_Component className={_utils.cx(_styles, "box", "store-80")} tag="section" id="cms">
			<_Builtin.Block
				className={_utils.cx(_styles, "header-wrap")}
				id={_utils.cx(_styles, "w-node-_2bbb3388-c74c-e0b3-2e35-422c2e89e0b7-2e89e0b6")}
				tag="div"
			>
			...
			<_Builtin.Block
				...
				id={_utils.cx(_styles, "w-node-_2bbb3388-c74c-e0b3-2e35-422c2e89e0bd-2e89e0b6")}
				tag="div"
			>
				<_Builtin.NotSupported _atom="DynamoWrapper" />
				<_Builtin.Block className={_utils.cx(_styles, "buttons-wrap")} tag="div">
					<_Builtin.Link
