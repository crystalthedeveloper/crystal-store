	...
	return React.createElement(
		...
		React.createElement(
			...
			React.createElement(
				...
				sources.map((url) => React.createElement("source", { src: url, key: url })),
			),
		),
		children,
	);
});
export const BackgroundVideoPlayPauseButton = React.forwardRef(function BackgroundVideoPlayPauseButton(
	{ children, className },
	ref,
) {
