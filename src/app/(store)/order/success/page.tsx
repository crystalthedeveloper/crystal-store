...
export default async function OrderDetailsPage({
	...
	// ✅ Safe fallback if secret key is missing (previews/builds)
	...
	// ✅ Import commerce-kit only when the secret exists (keeps builds happy)
	const Commerce: typeof import("commerce-kit") = await import("commerce-kit");
	...
	// ✅ use CommerceTypes for typing; type-only import so there’s no runtime hit
